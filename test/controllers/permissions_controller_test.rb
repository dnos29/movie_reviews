...
class PermissionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create permission" do
    assert_difference('Permission.count') do
      post permissions_url, params: { permission: { role_id: @permission.role_id, user_group_id: @permission.user_group_id } }
    end
  ...
  test "should update permission" do
    patch permission_url(@permission), params: { permission: { role_id: @permission.role_id, user_group_id: @permission.user_group_id } }
